...
export class SweetShop0__getCreatedNFTsRangeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class SweetShop0__getListedCreatedNFTsRangeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
  value2: Array<boolean>;
...
export class SweetShop0__getNFTsListStatusResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class SweetShop0 extends ethereum.SmartContract {
  static bind(address: Address): SweetShop0 {
    return new SweetShop0("SweetShop0", address);
  }
  ...
  getCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): SweetShop0__getCreatedNFTsRangeResult {
    let result = super.call(
      "getCreatedNFTsRange",
    ...
    return new SweetShop0__getCreatedNFTsRangeResult(
  ...
  try_getCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): ethereum.CallResult<SweetShop0__getCreatedNFTsRangeResult> {
    let result = super.tryCall(
      "getCreatedNFTsRange",
      "getCreatedNFTsRange(uint256,uint256):(uint256[],uint256[],bool[])",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SweetShop0__getCreatedNFTsRangeResult(
  ...
  getListedCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): SweetShop0__getListedCreatedNFTsRangeResult {
    let result = super.call(
      "getListedCreatedNFTsRange",
    ...
    return new SweetShop0__getListedCreatedNFTsRangeResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
      result[2].toBooleanArray()
    );
  ...
  try_getListedCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): ethereum.CallResult<SweetShop0__getListedCreatedNFTsRangeResult> {
    let result = super.tryCall(
      "getListedCreatedNFTsRange",
      "getListedCreatedNFTsRange(uint256,uint256):(uint256[],uint256[],bool[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SweetShop0__getListedCreatedNFTsRangeResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
        value[2].toBooleanArray()
      )
  ...
  getNFTsListStatus(
    nftIds: Array<BigInt>
  ): SweetShop0__getNFTsListStatusResult {
    let result = super.call(
      "getNFTsListStatus",
    ...
    return new SweetShop0__getNFTsListStatusResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_getNFTsListStatus(
    nftIds: Array<BigInt>
  ): ethereum.CallResult<SweetShop0__getNFTsListStatusResult> {
    let result = super.tryCall(
      "getNFTsListStatus",
      "getNFTsListStatus(uint256[]):(uint256[],uint256[])",
      [ethereum.Value.fromUnsignedBigIntArray(nftIds)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SweetShop0__getNFTsListStatusResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray()
      )
    );
