...
export class SubscriberMart__getCreatedNFTsRangeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class SubscriberMart__getListedCreatedNFTsRangeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
  value2: Array<boolean>;
...
export class SubscriberMart extends ethereum.SmartContract {
  static bind(address: Address): SubscriberMart {
    return new SubscriberMart("SubscriberMart", address);
  }
  ...
  creatorMart(): Address {
    let result = super.call("creatorMart", "creatorMart():(address)", []);

    return result[0].toAddress();
  }

  try_creatorMart(): ethereum.CallResult<Address> {
    let result = super.tryCall("creatorMart", "creatorMart():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): SubscriberMart__getCreatedNFTsRangeResult {
    let result = super.call(
      "getCreatedNFTsRange",
    ...
    return new SubscriberMart__getCreatedNFTsRangeResult(
  ...
  try_getCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): ethereum.CallResult<SubscriberMart__getCreatedNFTsRangeResult> {
    let result = super.tryCall(
      "getCreatedNFTsRange",
      "getCreatedNFTsRange(uint256,uint256):(uint256[],uint256[],bool[])",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SubscriberMart__getCreatedNFTsRangeResult(
  ...
  getListedCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): SubscriberMart__getListedCreatedNFTsRangeResult {
    let result = super.call(
      "getListedCreatedNFTsRange",
    ...
    return new SubscriberMart__getListedCreatedNFTsRangeResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
      result[2].toBooleanArray()
    );
  ...
  try_getListedCreatedNFTsRange(
    startNftId: BigInt,
    endNftId: BigInt
  ): ethereum.CallResult<SubscriberMart__getListedCreatedNFTsRangeResult> {
    let result = super.tryCall(
      "getListedCreatedNFTsRange",
      "getListedCreatedNFTsRange(uint256,uint256):(uint256[],uint256[],bool[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SubscriberMart__getListedCreatedNFTsRangeResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
        value[2].toBooleanArray()
      )
  ...
  try_treatSubscriptions(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "treatSubscriptions",
      "treatSubscriptions():(address)",
      []
...
export class UpdateCreatorMartCall extends ethereum.Call {
  get inputs(): UpdateCreatorMartCall__Inputs {
    return new UpdateCreatorMartCall__Inputs(this);
  }

  get outputs(): UpdateCreatorMartCall__Outputs {
    return new UpdateCreatorMartCall__Outputs(this);
  }
}

export class UpdateCreatorMartCall__Inputs {
  _call: UpdateCreatorMartCall;

  constructor(call: UpdateCreatorMartCall) {
    this._call = call;
  }

  get _newCreatorMartAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class UpdateCreatorMartCall__Outputs {
  _call: UpdateCreatorMartCall;
...
export class UpdateSubscriptionAddressCall extends ethereum.Call {
  get inputs(): UpdateSubscriptionAddressCall__Inputs {
    return new UpdateSubscriptionAddressCall__Inputs(this);
  }

  get outputs(): UpdateSubscriptionAddressCall__Outputs {
    return new UpdateSubscriptionAddressCall__Outputs(this);
  }
}

export class UpdateSubscriptionAddressCall__Inputs {
  _call: UpdateSubscriptionAddressCall;

  constructor(call: UpdateSubscriptionAddressCall) {
    this._call = call;
  }

  get _newSubAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class UpdateSubscriptionAddressCall__Outputs {
  _call: UpdateSubscriptionAddressCall;
...
export class ConstructorCall__Inputs {
  ...
  get _creatorMartAddress(): Address {
    return this._call.inputValues[4].value.toAddress();
  }

  get _treatSubscriptionsAddress(): Address {
